...
# include "src/mem/ft_mem.h"                  // IWYU pragma: export
# include "src/printf/ft_printf.h"            // IWYU pragma: export
# include "src/put/ft_put.h"                  // IWYU pragma: export
# include "src/str/ft_str.h"                  // IWYU pragma: export
# include "src/string/ft_string.h"            // IWYU pragma: export
